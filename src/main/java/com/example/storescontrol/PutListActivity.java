                ...
                try {
                    ...
                    if(response.code()==200) {
                       ...
                       if(object.getString("Resultcode").equals("200")){
                           ...
                           sharedPreferences.edit().putString("scan","").commit();
                ...
                public void onClick(View v) {
                    ...
                    builder.setTitle("提示").setMessage("删除此条数据").setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            String stringscandata=sharedPreferences.getString("scan","");
                            ...
                            sharedPreferences.edit().putString("scan",listcode.toString()).commit();
